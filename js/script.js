...
.done(function(data){
  data.Items.forEach(function(item, index){
    ...
    if(item.Item.genreId === "204174") {
      ...
      let pricePerLiterMes = '計算不可。もしくは猫砂ではありません。';
      let capacityNum = 0;
      if(capacity != null) {
        ...
        pricePerLiterMes = `1Lあたりの価格は<span class="emphasis">${roundedPrice}円</span>です。`;
      }
      ...
      <p class="price-per-liter">${pricePerLiterMes}</p>
